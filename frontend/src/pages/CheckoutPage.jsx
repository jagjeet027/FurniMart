    ...
    const initializeProduct = async () => {
      try {
        ...
        if (location.state?.product) {
          ...
          setSelectedSize(
            size || (productData.sizes ? productData.sizes[0] : "")
          );
          setLoading(false);
          return;
        }
        ...
        <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Thank you for your order. Your furniture will be manufactured
              soon.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your custom furniture is being crafted (7-14 days)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Quality assurance and finishing touches (1-2 days)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Careful packaging and delivery to your door (3-5 days)
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Unable to load product details for checkout.
          </p>
          <button
            onClick={() => navigate("/categories")}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Complete your order for custom furniture
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                ...
                <p className="text-xs text-blue-600 mt-1">
                  This item will be manufactured to order. Expected delivery:
                  2-3 weeks.
                </p>
              </div>
